...
The objective of this exercise is to explores the HTTP protocol operation using Wireshark packet analysis. You'll use CURL to generate controlled HTTP traffic (forcing IPv4 and plain HTTP) while capturing packets with Wireshark for detailed analysis.
