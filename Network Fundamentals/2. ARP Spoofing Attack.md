...
* Issue fake ARP replies stating that your MAC address maps to the victim's IP address (192.168.1.100) by running the following command:
...
* Extract the URLs by running the following command:
...
* The URL associated with the web request will show up in the terminal after a couple of minutes.
